...
//                                 String arrivalDestination = snapshot.data!.response![index].depIata.toString() ?? "---";
...
//                                       departureDestination: getCityName(arrivalDestination.toString())!,
...
//                                 String departureDestination = snapshot.data!.response![index].depIata.toString() ?? "Unknown";
...
//                                       departureDestination: getCityName(departureDestination.toString())!,
