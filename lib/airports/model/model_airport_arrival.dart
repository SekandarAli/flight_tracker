...
ModelAirportArrival modelAirportArrivalFromJson(String str) => ModelAirportArrival.fromJson(json.decode(str));

String modelAirportArrivalToJson(ModelAirportArrival data) => json.encode(data.toJson());

class ModelAirportArrival {
  ModelAirportArrival({
    this.request,
    this.response,
    this.terms,
  ...
  factory ModelAirportArrival.fromJson(Map<String, dynamic> json) => ModelAirportArrival(
