...
ModelAirportDepArr modelAirportDepArrFromJson(String str) => ModelAirportDepArr.fromJson(json.decode(str));

String modelAirportDepArrToJson(ModelAirportDepArr data) => json.encode(data.toJson());

class ModelAirportDepArr {
  ModelAirportDepArr({
    this.request,
    this.response,
    this.terms,
  ...
  factory ModelAirportDepArr.fromJson(Map<String, dynamic> json) => ModelAirportDepArr(
