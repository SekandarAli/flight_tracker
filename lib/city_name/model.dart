...
//
//     final modelCityName = modelCityNameFromJson(jsonString);

import 'dart:convert';

ModelCityName modelCityNameFromJson(String str) => ModelCityName.fromJson(json.decode(str));

String modelCityNameToJson(ModelCityName data) => json.encode(data.toJson());
...
class ModelCityName {
  ...
  factory ModelCityName.fromJson(Map<String, dynamic> json) => ModelCityName(
